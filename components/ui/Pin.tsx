      ...
      <div className="w-full h-full -mt-7 flex-none inset-0">
        <div className="absolute top-0 inset-x-0 flex justify-center">
          <a
            href={href}
            target={"_blank"}
            className="relative flex space-x-2 items-center z-10 rounded-full bg-zinc-950 py-0.5 px-4 ring-1 ring-orange-500/100"
          >
            {/* Fixed width for the title */}
            <span className="relative z-20 text-white  text-xs font-bold inline-block py-0.5 max-w-[200px] text-center truncate">
              {href}
            </span>
